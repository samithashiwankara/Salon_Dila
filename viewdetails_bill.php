...
<body background="images/1440x900.jpg">
	...
	<td><br><br>
		<center>
			<font size="5"> <a href="javascript:window.print()">Click to print !!
	</td>
	</tr></a></font>
	<br><br>
	<center><a href="view_bill.php?uid=<?php echo  $_SESSION['Reg_id']; ?>"><img src="images/fleche.png" width="35px">Back To Previous Page</a>
		<style>
			table {
				border-collapse: 2;
				width: 100%;
