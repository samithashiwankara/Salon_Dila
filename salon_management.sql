...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2021 at 08:07 AM
...
(10, 'adi@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 1, 9, 1);
...
(9, 'Shashith', 'Adithya', 'Male', 'home', 'Kuliyapitiya', 6, '7898799798', 'adi@gmail.com', 'dp.jpg', 1);
...
--
ALTER TABLE `tbl_appointment`
  MODIFY `App_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `tbl_district`
  MODIFY `Dis_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `tbl_login`
  MODIFY `Log_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tbl_registration`
  MODIFY `Reg_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
